...
public:
	...
	//initialisation
	static void    initCommunication(uint8_t myRST = DEFAULT_RST_PIN, uint8_t mySS = DEFAULT_SPI_SS_PIN, uint8_t myIRQ = 2 , SPIClass spi = SPI, uint8_t connection_num=1);
...
extern DW1000RangingClass DW2_1000Ranging;
